...
In the equation, $\pmb{\theta}$ is seem as 
...
In @eq-exm-spam-prior, we assumed a uniform prior for the classes. However, this may not reflect the true distribution of spam and non-spam messages in practice. To relax this assumption, we can estimate the class priors from the training data: